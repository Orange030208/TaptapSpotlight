...
assert(EnemyConfig.tree.touchDamage == 1.25, "tree monster must deal high melee damage")
...
assert(EnemyConfig.mushroom.projectile.damage == 0.75, "mushroom spore damage must stay low")
...
assert(EnemyConfig.dandelion.projectile.damage == 0.75, "dark dandelion seed damage must stay low")
...
assert(EnemyConfig.purple_orb.touchDamage == 0.75, "purple orb damage must stay low")
...
assert(EnemyConfig.shadow_wraith.touchDamage == 0.75)
