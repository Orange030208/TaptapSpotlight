...
return {
    ...
    soot = {
        ...
        activationRangeMeters = 5, activationRange = MetersToWorld(5),
    ...
    tree = {
        ...
        activationRangeMeters = 8, activationRange = MetersToWorld(8),
    ...
    ghost_a = {
        ...
        alwaysActive = true, activationRangeMeters = 30, activationRange = MetersToWorld(30),
        moveSpeed = 0.2, touchDamage = 1, contactCooldown = 2.25, parryStagger = 0.62,
        visual = Visual({ 255, 250, 238 }, { 251, 238, 111 }, { 197, 252, 72 }),
    },
    ghost_b = {
        behavior = "contact_chase", hp = 2, radius = 0.04,
        alwaysActive = false, activationRangeMeters = 5, activationRange = MetersToWorld(5),
        moveSpeed = 0.2, touchDamage = 1, contactCooldown = 2.25, parryStagger = 0.62,
    ...
    mushroom = {
        ...
        activationRangeMeters = 15, activationRange = MetersToWorld(15),
    ...
    toxic_moss = {
        ...
        activationRangeMeters = 0, activationRange = 0,
        moveSpeed = 0, immovable = true, touchDamage = 1,
