...
return {
    ...
    soot = {
        ...
        moveSpeed = 0.19, touchDamage = 0.75,
        attack = { interval = 1.45, telegraph = 0.37, active = 0.30, recovery = 0.52, dashSpeed = 0.92, arc = 70 },
    ...
    blue_swarm = {
        ...
        moveSpeed = 0.34, touchDamage = 0.75,
        attack = { interval = 0.7, repeatInterval = 0.7, telegraph = 0.17, active = 0.01, recovery = 0.09, range = MetersToWorld(3.5) },
    ...
    tree = {
        ...
        moveSpeed = 0.11, touchDamage = 1.25,
        attack = { interval = 1.5, repeatInterval = 1.5, telegraph = 0.47, active = 0.08, recovery = 0.22, range = MetersToWorld(4), arc = 60 },
    ...
    sap = {
        ...
        moveSpeed = 0.19, touchDamage = 0.75,
        attack = { interval = 1.25, telegraph = 0.25, active = 0.14, recovery = 0.34, range = MetersToWorld(1.5), arc = 60 },
    ...
    shadow_wraith = {
        ...
        moveSpeed = 0.2, touchDamage = 0.75, contactCooldown = 2.45, parryStagger = 0.65,
    ...
    stone = {
        ...
        moveSpeed = 0.26, preferredDistance = MetersToWorld(4.5), touchDamage = 0.75,
        attack = { interval = 0.92, telegraph = 0.27, active = 0.72, recovery = 0.24, dashSpeed = 1.45, arc = 360 },
    ...
    mushroom = {
        ...
        moveSpeed = 0.1, touchDamage = 0.75, minimumDistance = 0.2, maximumDistance = 0.43,
        attack = { interval = 0.36, repeatInterval = 0.5, telegraph = 0.06, recovery = 0.07 },
        projectile = { count = 1, speed = 0.48, style = "spore", radius = 0.016, damage = 0.75 },
    ...
    dandelion = {
        ...
        moveSpeed = 0, immovable = true, touchDamage = 0.75,
        attack = { interval = 0.75, repeatInterval = 1.2, telegraph = 0.25, recovery = 0.15 },
        projectile = {
            count = 10, pattern = "radial_random", speed = 0.42, style = "seed",
            minRadius = 0.01, maxRadius = 0.022, damage = 0.75,
        },
    ...
    purple_orb = {
        ...
        attackRangeMeters = 8, attackRange = MetersToWorld(8),
        moveSpeed = 0.08, minimumDistance = MetersToWorld(5.5), maximumDistance = MetersToWorld(7.8), touchDamage = 0.75,
        attack = { interval = 1.75, repeatInterval = 1.75, telegraph = 0.65, recovery = 0.18 },
        projectile = { count = 1, speed = 0.28, style = "bolt", radius = 0.013, damage = 0.75 },
        visual = Visual({ 253, 247, 255 }, { 208, 114, 255 }, { 115, 57, 160 }),
    },
    toxic_moss = {
        behavior = "ground_hazard", hp = 1, radius = 0.07,
        moveSpeed = 0, immovable = true, touchDamage = 0.25,
    ...
    boss = {
        ...
        touchDamage = 0.75, moveSpeed = 0.11, preferredDistance = 0.31,
